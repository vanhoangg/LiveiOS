...
public class UIDropDown: UIControl {
    ...
    // Closures
    fileprivate var privatedidSelect: (String, Int) -> Void = {_, _ in }
    ...
    // Actions Methods
    public func didSelect(completion: @escaping (_ option: String, _ index: Int) -> Void) {
        privatedidSelect = completion
    }

    public func tableWillAppear(completion: @escaping () -> Void) {
        privateTableWillAppear = completion
    }

    public func tableDidAppear(completion: @escaping () -> Void) {
        privateTableDidAppear = completion
    }

    public func tableWillDisappear(completion: @escaping () -> Void) {
        privateTableWillDisappear = completion
    }

    public func tableDidDisappear(completion: @escaping () -> Void) {
