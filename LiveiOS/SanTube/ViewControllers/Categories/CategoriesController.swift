...
private let column = UIDevice.current.userInterfaceIdiom == .pad ? CGFloat(5) : CGFloat(3)
...
//        addDefaultMenu()
        ...
        Server.shared.getCategories(UserManager.currentUser()?.id, loadCache: true) {[weak self] result in
            ...
            case .success(let list):
                ...
                Timer.scheduledTimer(withTimeInterval: 1, repeats: false, block: {[weak _self] _ in
